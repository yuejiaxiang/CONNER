...
python change_data_format_ner2tsv.py \
  --ner_file ../ner_process/output/20210128/roberta_large_quantity_only.json \
  --ere_file ../ere_process/input/20210128_roberta_large_quantity_only/ere_input_test \
  --mod_file ../mod_process/input/20210128_roberta_large_quantity_only/mod_input_test \
  --post_file ../post_process/20210128_roberta_large_quantity_only/ner_entities.json
...
cp ../mod_process/input/20210128_roberta_large_quantity_only/mod_input_test tmp/dev.tsv
export BERT_BASE_DIR=/dockerdata/yuejiaxiang/semeval_task8/mod_process/BERT_BASE_DIR/uncased_L-12_H-768_A-12
...
python change_data_format_ere2tsv.py \
  --ere_in_file ../ere_process/input/20210128_roberta_large_quantity_only/ere_input_test \
  --ere_out_file ../ere_process/output/20210128_roberta_large_quantity_only/ere_pred.json \
  --mod_in_file ../mod_process/input/20210128_roberta_large_quantity_only/mod_input_test \
  --mod_out_file ../mod_process/output/20210128_roberta_large_quantity_only/t0_e0_l0_r0.8_all
